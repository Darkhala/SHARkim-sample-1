...
function ensureAccountButton(){
  ...
  const btnClassesSmall = 'ml-1 flex items-center gap-2 px-3 py-2 bg-gray-800 text-white rounded hover:bg-gray-900';
  const btnClassesLarge = 'ml-2 flex items-center gap-2 px-4 py-2 bg-gray-800 text-white rounded hover:bg-gray-900 text-base';
